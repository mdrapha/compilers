...
static const yytype_int16 yyrline[] =
{
      ...
      60,    64,    70,    73,    79,    82,    88,    91,    97,   103,
     106,   112,   115,   121,   124,   127,   130,   133,   139,   142,
     148,   151,   157,   163,   166,   172,   175,   181,   184,   190,
     193,   199,   202,   205,   208,   211,   214,   220,   223,   226,
     232,   235,   238,   244,   247,   250,   253,   259,   265,   268,
     274,   277
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_LSQBRA", "T_RSQBRA", "T_SEMI", "T_COMMA", "$accept", "programa",
...
static const yytype_int8 yystos[] =
{
      ...
      33,     3,    22,    26,    28,     6,    35,    37,    38,    39,
       4,     3,    23,    29,    27,    26,    24,    40,    39,    28,
      27,    41,    34,    35,    42,     3,     3,     4,     7,     9,
      10,    22,    25,    28,    40,    43,    44,    45,    46,    47,
      48,    49,    50,    52,    53,    54,    55,    22,    26,    22,
      22,    28,    48,    48,    28,    15,    11,    12,    16,    17,
      18,    19,    20,    21,    51,    13,    14,    48,    56,    57,
      48,    48,    48,    28,    23,    48,    49,    53,    53,    52,
      54,    54,    23,    29,    27,    23,    23,    48,    43,    43,
       8,    43
};
...
#line 54 "parser.y"
                                     { (yyval.node) = createNode(nVarDeclaracao, (yyvsp[-2].node), NULL, NULL, (yyvsp[-1].num)); }
#line 1229 "parser.tab.c"
    break;

  case 8: /* var_declaracao: tipo_especificador T_ID T_LSQBRA T_NUM T_RSQBRA T_SEMI  */
#line 55 "parser.y"
                                                             { (yyval.node) = createNode(nVarDeclaracao, (yyvsp[-5].node), NULL, NULL, (yyvsp[-4].num)); }
...
#line 64 "parser.y"
                                                                     {
        (yyval.node) = createNode(nFunDeclaracao, (yyvsp[-5].node), (yyvsp[-2].node), (yyvsp[0].node), (yyvsp[-4].num));
    }
...
#line 88 "parser.y"
                              {
        (yyval.node) = createNode(nParam, (yyvsp[-1].node), NULL, NULL, (yyvsp[0].num));
    }
...
#line 91 "parser.y"
                                                {
        (yyval.node) = createNode(nParam, (yyvsp[-3].node), NULL, NULL, (yyvsp[-2].num)); 
    }
...
#line 181 "parser.y"
           {
        (yyval.node) = createNode(nVar, NULL, NULL, NULL, (yyvsp[0].num));
    }
...
#line 184 "parser.y"
                                       {
        (yyval.node) = createNode(nVar, NULL, (yyvsp[-1].node), NULL, (yyvsp[-3].num)); 
    }
...
#line 253 "parser.y"
            {
        (yyval.node) = createNode(nFator, NULL, NULL, NULL, (yyvsp[0].num));
    }
...
#line 259 "parser.y"
                                  {
        (yyval.node) = createNode(nAtivacao, NULL, NULL, NULL, (yyvsp[-3].num));
    }
